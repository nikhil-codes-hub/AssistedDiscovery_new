...
<xsl:value-of select="number(($var4_cur/target = 'AA'))"/>
<xsl:value-of select="number(($var4_cur/target = 'QF'))"/>
</xsl:variable>
<xsl:value-of select="number((boolean(translate(normalize-space($var200_nested), ' 0', '')) and (. = 'ADT')))"/>
</xsl:for-each>
</xsl:for-each>
</xsl:for-each>
</xsl:variable>
...
<xsl:value-of select="number((boolean(translate(normalize-space($var208_nested), ' 0', '')) and (. = 'ADT')))"/>
</xsl:for-each>
</xsl:variable>
...
<!--Manual change-->
<xsl:value-of select="concat($var252_nested, (./phone/node())[./self::text()])"/>
</Text>
<ActionCode>
<xsl:value-of select="'NN'"/>
</ActionCode>
...
<!--Manual change-->
<xsl:value-of select="concat($var260_nested, (./email/node())[./self::text()])"/>
</Text>
<ActionCode>
<xsl:value-of select="'NN'"/>
</ActionCode>
...
<AugPoint>
<!--Manual Change-->
<IndividualIDs xmlns="http://ndc.farelogix.com/aug">
<xsl:for-each select="actor">
...
<!-- Manual Change -->
<xsl:choose>
<xsl:when test="$var264_cur/docRef/taxIdentifier/fiscalType">
...
<xsl:for-each select="actor">
<xsl:variable name="var273_filter" select="."/>
...
<xsl:if test="(boolean(translate(normalize-space($var274_nested), ' 0', '')) and boolean(translate(normalize-space($var275_nested), ' 0', '')))">
<PassengerMetadata>
<xsl:for-each select="ID">
